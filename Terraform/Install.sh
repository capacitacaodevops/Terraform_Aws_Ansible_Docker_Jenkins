...
#docker run --rm --network host -v $ansible_path:/ansible diellyr/ansible -i $ansible_path/hosts all -m ping -vvv
...
#docker run --rm --network host -v $ansible_path:/ansible diellyr/ansible-playbook $ansible_path/docker_ubuntu.yml -i $ansible_path/hosts  
